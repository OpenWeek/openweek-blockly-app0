...
Maze.canMove = function(){
    switch(Maze.pegmanD){
        case 0: //North
            ...
            else return Maze.map[Maze.pegmanY-1][Maze.pegmanX] != Maze.SquareType.WALL
        case 1: //East
            if(Maze.pegmanX == Maze.map[0].length) return false
            else return Maze.map[Maze.pegmanY][Maze.pegmanX+1] != Maze.SquareType.WALL
        case 2: //South
            if(Maze.pegmanY == Maze.map.length) return false
            else return Maze.map[Maze.pegmanY+1][Maze.pegmanX] != Maze.SquareType.WALL
        case 3: //West
...
Maze.isInFrontOfEnemy = function(){
    switch(Maze.pegmanD){
        ...
        case 1: //East
            if(Maze.pegmanX == Maze.map.length) return false
            else return Maze.map[Maze.pegmanY][Maze.pegmanX+1] == Maze.SquareType.OBSTACLE
        case 2: //South
            if(Maze.pegmanY == Maze.map[0].length) return false
            else return Maze.map[Maze.pegmanY+1][Maze.pegmanX] == Maze.SquareType.OBSTACLE
        case 3: //West
            if(Maze.pegmanX == 0) return false
            else return Maze.map[Maze.pegmanY][Maze.pegmanX-1] == Maze.SquareType.OBSTACLE
